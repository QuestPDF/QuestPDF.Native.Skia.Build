...
internal static class SkPdfDocument
{
    ...
    {
        var instance = API.questpdf_skia_pdf_document_create(stream.Instance, in metadata);
    ...
    private static class API
    {
        ...
        public static extern IntPtr questpdf_skia_pdf_document_create(IntPtr stream, in SkPdfDocumentMetadata metadata);
    }
}