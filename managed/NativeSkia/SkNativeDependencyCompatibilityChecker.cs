...
internal static class SkNativeDependencyCompatibilityChecker
{
    ...
    private static Exception? CheckIfExceptionIsThrownWhenLoadingNativeDependencies()
    {
        try
        {
            ...
            var expected = a + b;
            var returned = API.questpdf_check_compatibility_by_calculating_sum(a, b);
    ...
    private static class API
    {
        ...
        [DllImport(SkiaAPI.LibraryName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int questpdf_check_compatibility_by_calculating_sum(int a, int b);
    }
}
